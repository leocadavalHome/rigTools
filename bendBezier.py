...
class FlexBezier:
    def __init__(self):
        ...
        pm.group (jntGrp, locGrp,noMoveCrvUp,noMoveCrvJnt,noMoveCrvUp, noMoveBend1,noMoveBend2,  p=noMoveSpace) 
        ...
        expre1 = "float $dummy = "+ramp1.name()+".outAlpha;float $output[];"
        expre2 = "float $dummy = "+ramp2.name()+".outAlpha;float $output[];"
        numJnts = 8    
        ...
        for i in range (1,(numJnts/2)+1):
            ...
            expre1=expre1+"$output = `colorAtPoint -o RGB -u "+str ((i/(numJnts/2.0))-(1.0/numJnts))+" -v 0.5 "+ramp1.name()+" `;"+cntrlName1+".scaleX = 1*$output[0];"+cntrlName1+".scaleY = 1*$output[0];"+cntrlName1+".scaleZ = 1*$output[0];"
            ...
            expre2=expre2+"$output = `colorAtPoint -o RGB -u "+str ((i/(numJnts/2.0))-(1.0/numJnts))+" -v 0.5 "+ramp2.name()+" `;"+cntrlName2+".scaleX = 1*$output[0];"+cntrlName2+".scaleY = 1*$output[0];"+cntrlName2+".scaleZ = 1*$output[0];"
